  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="ajaxForm" class="" action="<?php echo e(route('user.language.store')); ?>" method="POST">
          <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\eorder\resources\views/user/language/create.blade.php ENDPATH**/ ?>